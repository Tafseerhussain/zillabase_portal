<template>
    <div class="q-pa-md q-gutter-sm">
        <common-table title="External & Embedded" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit."
            :columns="tableColumns" :rows="tableData" buttonLabel="Add function" searchInputPlaceholder="Functions" @delete-row="openDeleteDialog" @add-new="openFunctionDialog" />
    </div>

    <q-dialog v-model="addNewFunction" persistent full-height maximized position="right"  backdrop-filter="blur(4px)" class="add-new-dialog">
        <q-card class="full-height">
          ...
          <q-card-section class="q-py-xl px-28">
              ...
              <div class="row items-center q-mt-lg">
                <div class="col-3">
                  <span class="text-custom-gray-dark text-subtitle1 text-weight-light">Return Type</span>
                </div>
                <div class="col-9">
                  <q-input
                    dense
              ...
              <div class="row items-center q-mt-lg">
                <div class="col-3">
                  <span class="text-custom-gray-dark text-subtitle1 text-weight-light">Language</span>
                </div>
                <div class="col-9">
                    <q-select
            ...
            <q-card-section class="q-py-lg px-28">
              <div class="flex justify-between items-center q-mb-sm">
                <p class="text-custom-text-secondary text-subtitle1 fw-600">Paramters</p>
                <div>
                  <q-tooltip  
                    anchor="center left" 
                    self="center end">
            ...
            <q-card-section class="q-py-lg px-28">
                <div class="row items-start">
                    <div class="col-3">
                    <span class="text-custom-gray-dark text-subtitle1 text-weight-light">Body</span>
                    </div>
                    <div class="col-9">
                    <q-input
                        outlined
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            tableData: [
                { id: 1, name: "Example Data Table", parameters: "Lorem ipsum", returnType: "Lorem ipsum", language: "PHP", type:"External"},
                { id: 2, name: "Example Data Table", parameters: "Lorem ipsum", returnType: "Lorem ipsum", language: "JavaScript", type:"Embedded"},
                { id: 3, name: "Example Data Table", parameters: "Lorem ipsum", returnType: "Lorem ipsum", language: "R", type:"External"},
                { id: 4, name: "Example Data Table", parameters: "Lorem ipsum", returnType: "Lorem ipsum", language: "PHP", type:"Embedded"},
                { id: 5, name: "Example Data Table", parameters: "Lorem ipsum", returnType: "Lorem ipsum", language: "SQL", type:"External"},
                { id: 6, name: "Example Data Table", parameters: "Lorem ipsum", returnType: "Lorem ipsum", language: "Python", type:"Embedded"},
            ],
            functionTypeRow: [
