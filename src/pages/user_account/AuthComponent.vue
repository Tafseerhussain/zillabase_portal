<template>
    ...
    <!-- add user Dialog -->
    <q-dialog v-model="addNewUser" persistent full-height maximized position="right" backdrop-filter="blur(4px)"
        ...
        <q-card class="full-height" style="width: 871px; max-width: 80vw;">
            <q-card-section class="flex justify-between items-center q-pa-lg">
                <div class="flex q-gutter-lg">
                    <q-btn unelevated color="light-green" :icon="addNewUser ? 'chevron_left' : 'chevron_right'"
                        style="width: 30px; min-height: 30px" @click="addNewUser = !addNewUser"
                        class="rounded-10" />
                    <p class="text-custom-text-secondary text-h6 fw-600">
                        Create New User
                    </p>
                </div>
                <q-icon name="img:/icons/auth.svg" class="fs-30 filter-custom-dark" style="min-height: 30px;" />
            </q-card-section>
            <q-separator />
            <q-card-section class="q-py-xl px-28">
                <div class="row items-center">
                    ...
                    <div class="col-9">
                        <q-input dense outlined placeholder="User Name"
                            class="rounded-10 self-center text-weight-light rounded-input" />
                    </div>
                </div>
                <div class="row items-center q-mt-lg q-pt-md">
                    <div class="col-3">
                        <span class="text-custom-gray-dark text-subtitle1 text-weight-light">Email</span>
                    </div>
                    <div class="col-9">
                        <q-input dense outlined placeholder="User Email" type="email"
                            class="rounded-10 self-center text-weight-light rounded-input" />
                    </div>
                </div>
            </q-card-section>
            ...
            <q-card-section class="flex justify-end q-gutter-lg q-pa-lg">
                <q-btn unelevated label="Cancel" :ripple="false" color="dark"
                    class="text-capitalize rounded-10 highlighted-border" />
                <q-btn unelevated label="Add User" icon="add" :ripple="false"
                    class="bg-light-green rounded-10 text-white text-capitalize self-center" />
            </q-card-section>
        </q-card>
    </q-dialog>
    <!-- add provider Dialog -->
    <q-dialog v-model="addNewProvider" persistent full-height maximized position="right" backdrop-filter="blur(4px)"
        class="add-new-dialog">
        <q-card class="full-height" style="width: 871px; max-width: 80vw;">
            <q-card-section class="flex justify-between items-center q-pa-lg">
                <div class="flex q-gutter-lg">
                    <q-btn unelevated color="light-green" :icon="addNewProvider ? 'chevron_left' : 'chevron_right'"
                        style="width: 30px; min-height: 30px" @click="addNewProvider = !addNewProvider"
                        class="rounded-10" />
                    <p class="text-custom-text-secondary text-h6 fw-600">
                        Add A Provider
                    </p>
            ...
            <q-card-section class="q-py-xl px-28">
                <div class="row items-center">
                    ...
                    <div class="col-9">
                        <q-input dense outlined placeholder="e.g Google"
                            class="rounded-10 self-center text-weight-light rounded-input" />
                    </div>
                </div>
                <div class="row items-center q-mt-lg q-pt-md">
                    <div class="col-3 flex items-center">
                        <span class="text-custom-gray-dark text-subtitle1 text-weight-light">Enabled</span>
                        <q-icon   
            ...
            <q-card-section class="flex justify-end q-gutter-lg q-pa-lg">
                <q-btn unelevated label="Cancel" :ripple="false" color="dark"
                    class="text-capitalize rounded-10 highlighted-border" />
                <q-btn unelevated label="Add Provider" icon="add" :ripple="false"
                    class="bg-light-green rounded-10 text-white text-capitalize self-center" />
            </q-card-section>
        </q-card>
    </q-dialog>
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            ssoTableColumns: [
                { name: "providers", label: "Providers", align: "left", field: "providers", sortable: true },
