<template>
    <div class="q-pa-md q-gutter-sm">
        <common-table title="ZStreams" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit."
            :columns="tableColumns" :rows="tableData" buttonLabel="Add Stream" searchInputPlaceholder="Streams"
            @delete-row="openDeleteDialog" @add-new="openTableDialog" />
    </div>
    <!-- add Dialog -->
    <q-dialog v-model="addNewStream" persistent full-height maximized position="right" backdrop-filter="blur(4px)"
        ...
        <q-card class="full-height" style="width: 871px; max-width: 80vw;">
            <q-card-section class="flex justify-between items-center q-pa-lg">
                <div class="flex q-gutter-lg">
                    <q-btn unelevated color="light-green" :icon="addNewStream ? 'chevron_left' : 'chevron_right'"
                        style="width: 30px; min-height: 30px" @click="addNewStream = !addNewStream"
                        class="rounded-10" />
            ...
            <q-card-section class="q-py-xl px-28">
                <div class="row items-center">
                    ...
                    <div class="col-9">
                        <q-input dense outlined placeholder="Stream Name"
            ...
            <q-card-section class="flex justify-end q-gutter-lg q-pa-lg">
                ...
                <q-btn unelevated label="Add Stream" icon="add" :ripple="false"
    ...
    data() {
        return {
            ...
            tableColumns: [
                ...
                { name: "streamType", label: "Type", align: "left", field: "streamType" },
                {
                    name: "streamFunction",
